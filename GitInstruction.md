...
Для того, чтобы установить VSCode на Ваш компьютер пройдите по ссылке "https://code.visualstudio.com/download". После установки закройте его.

### Установка git на ваш ПК
Для установки git на Ваш компьютер пройдите по ссылке "https://git-scm.com/book/ru/v2/Введение-Установка-Git". Перезагрузите компьютер.
